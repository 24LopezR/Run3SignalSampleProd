...
# with command line options: Configuration/Generator/python/HTo2LongLivedTo4mu_MH-1600_MFF-50_CTau-100000mm_TuneCP5_13p6TeV_pythia8_cff.py --python_filename HTo2LongLivedTo4mu_MH-1600_MFF-50_CTau-100000mm_TuneCP5_13p6TeV_pythia8_GENSIM_cff.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout output_GS.root --conditions 124X_mcRun3_2022_realistic_postEE_v1 --beamspot Realistic25ns13p6TeVEarly2022Collision --step GEN,SIM --geometry DB:Extended --era Run3 --no_exec --mc -n 200 --nThreads 8
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/Generator/python/HTo2LongLivedTo4mu_MH-1600_MFF-50_CTau-100000mm_TuneCP5_13p6TeV_pythia8_cff.py nevts:200'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/eos/user/r/rlopezru/DisplacedDimuons/HTo2LLTo4mu_1600_50_100000mm_WF/output_GS.root'),
