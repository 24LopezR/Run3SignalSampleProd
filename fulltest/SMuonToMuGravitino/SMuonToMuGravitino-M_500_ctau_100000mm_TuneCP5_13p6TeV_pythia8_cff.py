...
# PDG code           mass       particle
   ...
   1000011    4.50000000E+05  #
   2000011    4.50000000E+05  #
   1000012    4.50000000E+05  #
   1000013    {msmuon:E}  #
   2000013    {msmuon:E}  #
   1000014    4.50000000E+05  #
   1000015    4.50000000E+05  #
   2000015    4.50000000E+05  #
...
BLOCK STOPMIX  # Stop Mixing Matrix
  1  1     1.00000000E+00   # O_11
  1  2     0.00000000E+00   # O_12
  2  1     0.00000000E+00   # O_21
  2  2     1.00000000E+00   # O_22
#
...
#
#         PDG            Width
DECAY   1000011     2.13682161E-01   # selectron_L
#          BR         NDA      ID1       ID2
     1.0000    2     1000039    11
#
#         PDG            Width
DECAY   2000011     2.16121626E-01  # selectron_R
#          BR         NDA      ID1       ID2
     1.0000    2     1000039    11
#
#         PDG            Width
DECAY   1000013     {width:E}   # smuon_L
#          BR         NDA      ID1       ID2
     1.0000    2     1000039    13
#
#         PDG            Width
DECAY   2000013     {width:E}   # smuon_R
#          BR         NDA      ID1       ID2
     1.0000    2     1000039    13
#
#         PDG            Width
DECAY   1000015     1.48327268E-01   # stau_1
#          BR         NDA      ID1       ID2
     1.0000    2     1000039    15
#         PDG            Width
DECAY   2000015     2.69906096E-01   # stau_2
#          BR         NDA      ID1       ID2
     1.0000    2     1000039    15
#         PDG            Width
...
'''.format(msmuon = MASS, width = WIDTH)
...
# need the pythia generator (as oppposed EXO-18-013, where generation was done in aMC@NLO)
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            '1000013:mayDecay = on', # left-handed smuon
            '1000013:tau0 = %.1f' % CTAU,
            '2000013:mayDecay = on', # right-handed smuon
            '2000013:tau0 = %.1f' % CTAU,
            '1000039:mayDecay = false', # gravitino is stable
        ),
